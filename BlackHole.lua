...
local Library do
    ...
    Library.Pages.SubPage = function(self, Data)
        ...
        if SubPage.Page.Search then 
            local function UpdateSearch()
                for Index, Value in SubPage.SearchItems do 
                    ...
                    if SearchText == "" then
                        ...
                        if Element.SetVisiblity then
                            Element:SetVisiblity(true)
                        elseif Element.Instance then
                            Element.Instance.Visible = true
                        end
                        Section:SetVisibility(true)
                        if Element.ChangeItemTheme then
            ...
            -- Use RenderStepped for mobile compatibility instead of Changed event
